...
App link to show albums: [https://anna-album-app.onrender.com/albums](https://anna-album-app.onrender.com/albums)

## Deployment Steps
1. Pushed the local Express project to this [GitHub repository](https://github.com/AnnaJouppi/album-app/tree/main).
